...
public final class Taskmaster implements Model {
  ...
  private Taskmaster(String id, String title, String body, Status status, String s3ImageKey, String lat, String lon, String teamID) {
    this.id = id;
    this.title = title;
    this.body = body;
    this.status = status;
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String title, String body, Status status, String s3ImageKey, String lat, String lon, String teamId) {
      super.id(id);
      super.title(title)
        .status(status)
        .teamId(teamId)
